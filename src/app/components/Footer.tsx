...
const NRKLogo = styled.svg`
  height: 24px;
  fill: #222; /* Match footer text color */
`;

const MetLogo = styled.svg`
  height: 24px;
  fill: #222; /* Match footer text color */
`;
    ...
    <FooterContainer>
      ...
      <Logos>
        ...
        <NRKLogo
          ...
          viewBox="0 0 68 24"
          role="img"
          aria-label="Norwegian Broadcasting Corporation"
        >
          <path
            fill="currentColor"
            fillRule="evenodd"
        ...
        {/* Norwegian Meteorological Institute Logo SVG */}
        <MetLogo
          xmlns="http://www.w3.org/2000/svg"
          className="logo-met"
          width="89"
